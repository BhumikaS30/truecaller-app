package com.practice.truecaller;
...
import com.practice.truecaller.models.Business;
import com.practice.truecaller.models.GlobalContacts;
import com.practice.truecaller.models.UserAccount;
import com.practice.truecaller.models.UserCategory;
...
public class TrueCallerApplication {
    ...
    public static void main(String[] args) throws ContactsExceededException, BlockContactsExceededException {

        //Test case 1: Create user and register
        UserAccount account1 = new UserAccount();
        account1.register(UserCategory.STANDARD, "u1", "pwd",
                          "u1@email.com", "6826999256", "91", "u1");

        // Test case 2: Add contacts to user
        account1.addContacts(new UserAccount("9140107431","mahadev"));
        account1.addContacts(new UserAccount("8558101117","govind", "hs"));
        account1.addContacts(new UserAccount("8723937942","gopala"));
        account1.addContacts(new UserAccount("7070063864","mahesha"));
        account1.addContacts(new UserAccount("6610448270","parvathi"));
        account1.addContacts(new UserAccount("7336175457","parameshwari"));
        account1.addContacts(new UserAccount("7202250272","narayan"));
        account1.addContacts(new UserAccount("7859999997","lakshmi"));
        account1.addContacts(new UserAccount("9653498522","ganesh", "kumar"));
        account1.addContacts(new UserAccount("7277115893","ganapathy"));
        account1.addContacts(new UserAccount("9495010564","Bhrama"));
        account1.addContacts(new UserAccount("9844296241","Saraswathi"));
        account1.addContacts(new UserAccount("7917949575","a.Veena"));
        ...
        account1.addContacts(new UserAccount("3949345003","Blocked caller1"));
        account1.addContacts(new UserAccount("4953904850","Blocked caller2"));
        account1.addContacts(new UserAccount("2782348999","Junk caller3"));
        ...
        account1.unBlockNumbers("3949345003");
        System.out.println(account1.isBlocked("3949345003"));
        ...
        account2.register(UserCategory.STANDARD,"u2","pwd",
                          "u2@email.com","6826999256", "91", "u2");

        // Test case 13: Add contacts to user
        account2.addContacts(new UserAccount("7373048205","anil"));
        account2.addContacts(new UserAccount("7373113132","aravind", "hs"));
        account2.addContacts(new UserAccount("7373292767","vimal"));
        account2.addContacts(new UserAccount("7373358224","smitha"));
        account2.addContacts(new UserAccount("7373441841","alamelu"));
        account2.addContacts(new UserAccount("7373514930","alagappan"));
        account2.addContacts(new UserAccount("7373659939","aruna"));
        account2.addContacts(new UserAccount("7373782605","seetha"));
        account2.addContacts(new UserAccount("7373860476","rama", "kumar"));
        account2.addContacts(new UserAccount("7373954330","ramganesh"));
        account2.addContacts(new UserAccount("7071043159","muruga"));
        account2.addContacts(new UserAccount("7071115445","kandha"));
        account2.addContacts(new UserAccount("7071215591","siva"));
